...
const PrivacyPolicy = () => {
  return (
    <div
      className={`px-4 md:px-8 lg:px-16 py-8 md:py-12 flex flex-col gap-y-6 md:gap-y-8`}
    >
      ...
      <section>
        <p className="text-sm font-normal leading-[21px]">
          My Medical Journal (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
          &ldquo;us&rdquo;) is committed to protecting your privacy. This
          Privacy Policy explains how your personal information is collected,
          used, and disclosed by My Medical Journal.
        </p>
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          My Medical Journal. By accessing or using our Service, you signify
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          to use the My Medical Journal Service to manage the relationships with
        ...
        <p className="text-sm font-normal leading-[21px]">
          Personnel: refers to those individuals who are employed by My Medical
          Journal or are under contract to perform a service on behalf of one of
          the parties.
        </p>
        <p className="text-sm font-normal leading-[21px]">
        ...
        <p className="text-sm font-normal leading-[21px]">Name / Username</p>
        <p className="text-sm font-normal leading-[21px]">Phone Numbers</p>
        <p className="text-sm font-normal leading-[21px]">Email Addresses</p>
        <p className="text-sm font-normal leading-[21px]">Password</p>
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">
          When does My Medical Journal use end user information from third
          parties?
        </p>
        <p className="text-sm font-normal leading-[21px]">
          My Medical Journal will collect End User Data necessary to provide the
          My Medical Journal services to our customers. End users may
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">
          When does My Medical Journal use customer information from third
          parties?
        </p>
        <p className="text-sm font-normal leading-[21px]">
          ...
          interest in becoming a My Medical Journal customer, we receive
          information from a third party that provides automated fraud detection
          services to My Medical Journal. We also occasionally collect
        ...
        <p className="text-sm font-normal leading-[21px]">
          My Medical Journal will collect personal information that you submit
        ...
        <p className="text-sm font-normal leading-[21px]">
          We keep your information only so long as we need it to provide My
          Medical Journal to you and fulfill the purposes described in this
          ...
          we&rsquo;ll either remove it from our systems or depersonalize it so
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          absolute security of any information you transmit to My Medical
          Journal or guarantee that your information on the Service may not be
        ...
        <p className="text-sm font-normal leading-[21px]">
          My Medical Journal is incorporated in United States. Information
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">
          Is the information collected through the My Medical Journal Service
          secure?
        </p>
        <p className="text-sm font-normal leading-[21px]">
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          information My Medical Journal collects depend on your relationship
          with My Medical Journal. Personnel may update or correct their
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">Sale of Business</p>
        <p className="text-sm font-normal leading-[21px]">
          ...
          of the assets of My Medical Journal or any of its Corporate Affiliates
          (as defined herein), or that portion of My Medical Journal or any of
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">Affiliates</p>
        <p className="text-sm font-normal leading-[21px]">
          ...
          control with My Medical Journal, whether by ownership or otherwise.
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">Governing Law</p>
        <p className="text-sm font-normal leading-[21px]">
        ...
        <p className="text-sm font-normal leading-[21px]">
          By using My Medical Journal or contacting us directly, you signify
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          it&apos;s being used. By using our My Medical Journal, registering an
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          contain links to other websites not operated or controlled by My
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          within your browser, you should visit your browser&apos;s help menu
        ...
        <p className="text-sm font-normal leading-[21px]">Sessions&nbsp;</p>
        <p className="text-sm font-normal leading-[21px]">
        ...
        <p className="text-[30px] font-semibold mt-3 mb-2">What is GDPR?</p>
        <p className="text-sm font-normal leading-[21px]">
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          the EU-based businesses and EU residents. Our customers&rsquo; data is
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          the right thing to do. At My Medical Journal we strongly believe that
        ...
        <p className="text-sm font-normal leading-[21px]">
          ...
          requirements of GDPR. My Medical Journal processes or stores all
...
// sectoin className="flex flex-col gap-y-3"
// className="text-[30px] font-semibold mt-3 mb-2" heading
// para className="text-sm font-normal leading-[21px]"
// ul className="list-disc text-sm font-normal leading-[21px] flex flex-col gap-y-1"
